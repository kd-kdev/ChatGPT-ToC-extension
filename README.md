...
Adds a table of contents with links to user messages to ChatGPT chats.

ChatGPT Table of Contents is a simple, lightweight extension that seamlessly integrates into the existing ChatGPT interface.
